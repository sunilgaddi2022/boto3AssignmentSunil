...
function_name = 'Sunil-GaddiBoto3LambdaFuntion'
role_arn = 'arn:aws:iam::295397358094:role/service-role/Sunil-Gaddi-LambdaBasedHealthChecks-role-a9vi6y8e'  # Replace with your existing IAM role ARN
...
response1 = lambda_client.add_permission(
    FunctionName='Sunil-GaddiBoto3LambdaFuntion',
