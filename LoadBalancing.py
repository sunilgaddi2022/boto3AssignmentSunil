...
ec2_client = boto3.client('ec2', region_name='ap-east-1')  # Replace 'your-region' with your AWS region

# Define the instance name you want to look up
instance_name = 'Sunil-GaddiFE'  # Replace with the instance name you're searching for
