...
ubuntu_ami_id = 'ami-0287a05f0ef0e9d11'  # Replace with the actual AMI ID you find for your Ubuntu version and region
...
ec2.meta.client.associate_address(InstanceId=instance.id, PublicIp='44.220.178.98')

print("New Ubuntu Frontend instance is created and associated with Elastic IP (44.220.178.98).")
