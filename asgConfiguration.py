...
autoscaling_client = boto3.client('autoscaling', region_name='ap-east-1')
elbv2_client = boto3.client('elbv2', region_name='ap-east-1')

# Define the instance name you want to look up
instance_name = 'SunilG_TravelMemoryFE'  # Replace with the instance name you're searching for
...
ami_name = f'SunilG_TravelMemoryFEAMI-{timestamp}'
print(instance_id)
...
asg_name = 'Sunil-Gaddi-ASG'
min_size = 1
max_size = 3
desired_capacity = 1
availability_zones = ['ap-east-1b', 'ap-east-1c']

launch_template_name = 'Sunil-Gaddi-FE-Launch-Template'
cpu_utilization_target = 50
load_balancer_name = 'Sunil-Gaddi-load-balancer'
...
target_group_arn = 'Sunil-Gaddi-target-group'
